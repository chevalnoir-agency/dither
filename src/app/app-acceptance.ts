...
export const appTransferMode: ToolcraftTransferMode = {
  animationIntent: {
    loopDuration: {
      evidence:
        "Reference screen recording metadata reports an 11.88166666666667s H.264 QuickTime duration; extracted frames at 0, 2, 4, 6, 8, and 10 seconds show one forward breathing cycle returning toward the sparse high-contrast state.",
      seconds: 11.88166666666667,
      source: "reference",
    },
    mode: "timeline-playback",
  },
  ...
  videoReferenceStudy: {
    acceptanceMapping: [
      {
        acceptanceId: "reference.video.motif",
        behavior:
          "The output uses a black-backed ASCII/dither field with organic void islands, wave bands, and cross/dot particles derived from the reference frames and the latest visual direction.",
        frameIds: ["f000", "f002", "f004", "f006", "f008", "f010"],
      },
      {
        acceptanceId: "reference.video.motion",
        behavior:
          "The animation breathes forward from sparse/high-contrast regions into denser gray fields and back without mirror, yoyo, ping-pong, or reverse motion.",
        frameIds: ["f000", "f004", "f008", "f010"],
      },
    ],
    ...
    referenceLocation:
      "/Users/pierrevoisin/Desktop/Enregistrement de l’écran 2026-07-04 à 10.20.45.mov",
    storyboard: [
      {
        behaviorObservation:
          "The loop begins in a sparse, high-contrast state with large black gaps and scattered bright cells.",
        frameId: "f000",
        frameSource: "docs/toolcraft/reference-video-frames/frame_0s.png",
        timeSeconds: 0,
        visualObservation:
          "Black canvas with white dotted/cross ASCII cells forming partial rectangular islands and diagonal bands.",
      },
      {
        behaviorObservation:
          "Sparse islands shift and reveal new block silhouettes while retaining the same grid scale.",
        frameId: "f002",
        frameSource: "docs/toolcraft/reference-video-frames/frame_2s.png",
        timeSeconds: 2,
        visualObservation:
          "Large black regions remain, with bright ASCII clusters moving into vertical and diagonal patches.",
      },
      {
        behaviorObservation:
          "The field transitions into a denser mid-gray dither phase with broad wave arcs.",
        frameId: "f004",
        frameSource: "docs/toolcraft/reference-video-frames/frame_4s.png",
        timeSeconds: 4,
        visualObservation:
          "The canvas is more filled; circular/diagonal wave bands and rectangular patches are visible.",
      },
      {
        behaviorObservation:
          "Density peaks into a soft gray texture while darker channels still cut through the field.",
        frameId: "f006",
        frameSource: "docs/toolcraft/reference-video-frames/frame_6s.png",
        timeSeconds: 6,
        visualObservation:
          "Most of the canvas is filled by dim ASCII particles, with black rifts and block boundaries.",
      },
      {
        behaviorObservation:
          "Dense regions drift forward and begin releasing back toward darker negative space.",
        frameId: "f008",
        frameSource: "docs/toolcraft/reference-video-frames/frame_8s.png",
        timeSeconds: 8,
        visualObservation:
          "A gray all-over dither field remains, but strong black shapes start reappearing.",
      },
      {
        behaviorObservation:
          "The loop returns toward a sparse, high-contrast state that can stitch back to the start.",
        frameId: "f010",
        frameSource: "docs/toolcraft/reference-video-frames/frame_10s.png",
        timeSeconds: 10,
        visualObservation:
          "Black gaps dominate again with rectangular ASCII islands and bright particle clusters.",
      },
    ],
    transitionAnalysis: [
      {
        behaviorDelta:
          "From f000 to f002, rectangular ASCII islands drift and new bands appear while the grid scale and black backing persist.",
        fromFrameId: "f000",
        id: "f000-f002",
        toFrameId: "f002",
      },
      {
        behaviorDelta:
          "From f002 to f004, the visible cell count increases and wave arcs broaden, showing density breathing rather than a static random shuffle.",
        fromFrameId: "f002",
        id: "f002-f004",
        toFrameId: "f004",
      },
      {
        behaviorDelta:
          "From f004 to f006, particles become dimmer and more numerous, producing a mid-gray dither veil with preserved block boundaries.",
        fromFrameId: "f004",
        id: "f004-f006",
        toFrameId: "f006",
      },
      {
        behaviorDelta:
          "From f006 to f008, dense gray texture advances forward while black rifts reopen, starting the release phase.",
        fromFrameId: "f006",
        id: "f006-f008",
        toFrameId: "f008",
      },
      {
        behaviorDelta:
          "From f008 to f010, the field clears back to sparse high-contrast islands, preparing the first/last frame stitch.",
        fromFrameId: "f008",
        id: "f008-f010",
        toFrameId: "f010",
      },
...
export const appAcceptance: readonly ToolcraftComponentAcceptance[] = [
  {
    automated: true,
    automatedTestName: "particle type changes ASCII glyph output",
    browser: true,
  ...
  {
    automated: true,
    automatedTestName: "scale changes ASCII grid resolution",
    browser: true,
    browserTestName: "browser: pattern controls change ASCII output",
    componentType: "slider",
    evidence: "product-output",
    expectedObservable:
      "Dragging Scale changes the ASCII cell size and the visible grid resolution.",
    fixture: "dense ASCII pattern fixture",
    id: "pattern.scale",
    kind: "control",
    target: "pattern.scale",
    userAction:
      "Drag the Scale slider and verify live product output changes during the drag.",
  },
  {
    automated: true,
    automatedTestName: "density changes visible particle count",
    browser: true,
    browserTestName: "browser: pattern controls change ASCII output",
    componentType: "slider",
    evidence: "product-output",
    expectedObservable:
      "Dragging Density changes how many ASCII particles survive the dither mask.",
    fixture: "default ASCII pattern fixture",
    id: "pattern.density",
    kind: "control",
    target: "pattern.density",
    userAction:
      "Drag the Density slider and verify live product output changes during the drag.",
  },
  {
    automated: true,
    automatedTestName: "spacing changes particle separation",
    browser: true,
    browserTestName: "browser: pattern controls change ASCII output",
    componentType: "slider",
    evidence: "product-output",
  ...
  {
    automated: true,
    automatedTestName: "speed changes timeline-driven field drift",
    browser: true,
    browserTestName: "browser: motion speed and timeline change rendered frames",
    componentType: "slider",
    evidence: "timeline-output",
    expectedObservable:
      "Changing Speed alters the distance traveled by the procedural field across the same timeline duration.",
    fixture: "playing timeline ASCII pattern fixture",
    id: "motion.speed",
    kind: "control",
    target: "motion.speed",
    userAction:
      "Drag Speed, scrub the timeline, and compare rendered frames at the same timeline positions.",
  },
  {
    automated: true,
    automatedTestName: "dither strength changes contrast",
    browser: true,
    browserTestName: "browser: dither controls change ASCII output",
    componentType: "slider",
    evidence: "product-output",
    expectedObservable:
      "Dragging Strength changes the contrast between sparse black gaps and dense gray particle fields.",
    fixture: "mid-density ASCII pattern fixture",
    id: "dither.strength",
    kind: "control",
  ...
  {
    automated: true,
    automatedTestName: "dither threshold changes particle cutoff",
    browser: true,
    browserTestName: "browser: dither controls change ASCII output",
    componentType: "slider",
    evidence: "product-output",
    expectedObservable:
      "Dragging Threshold moves the cutoff between black gaps and visible ASCII particles.",
    fixture: "mid-density ASCII pattern fixture",
    id: "dither.threshold",
    kind: "control",
    target: "dither.threshold",
    userAction:
      "Drag Threshold and verify live product output changes during the drag.",
  },
  {
    automated: true,
    automatedTestName: "background color changes preview and exports",
    browser: true,
    browserTestName: "browser: background and image export produce correct files",
    componentType: "color",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Background recolors the product background in preview, PNG/JPG export, and video export.",
    fixture: "ASCII pattern with included background",
    id: "appearance.background",
    kind: "control",
    target: "appearance.background",
    userAction:
      "Change Background color, export PNG, and verify preview and exported pixels use the current background.",
  },
  {
    automated: true,
    automatedTestName: "include background controls preview png alpha and video background",
    browser: true,
    browserTestName: "browser: background and image export produce correct files",
    componentType: "switch",
    evidence: "exported-bytes",
    expectedObservable:
      "Turning Include off hides the live preview product background, creates transparent PNG alpha output, and video export still keeps the product background.",
    fixture: "ASCII pattern with include background toggled off",
    id: "export.includeBackground",
    kind: "control",
    target: "export.includeBackground",
    userAction:
      "Toggle Include background off, verify preview background is hidden, export transparent PNG, then export video and verify video keeps background.",
  },
  {
    automated: true,
    ...
    evidence: "exported-bytes",
    expectedObservable:
      "Choosing PNG or JPG changes the image export MIME type and file extension.",
    fixture: "default ASCII image export fixture",
    id: "export.image.format",
    kind: "control",
    optionCoverage: ["png", "jpg"],
    target: "export.image.format",
    userAction:
      "Choose JPG in Image Export Format, export the image, and decode the output as JPEG bytes.",
  },
  {
    automated: true,
    ...
    evidence: "exported-bytes",
    expectedObservable:
      "Choosing 2K, 4K, or 8K changes actual exported image dimensions; 8K produces an 8192px long edge.",
    fixture: "default ASCII image export fixture",
    ...
    userAction:
      "Choose 2K and 8K, export images, and decode actual image width and height.",
  },
  {
    automated: true,
    automatedTestName: "video format selects supported recorder container",
    browser: true,
    browserTestName: "browser: video export produces timeline-duration metadata",
    componentType: "select",
    evidence: "exported-bytes",
    expectedObservable:
      "Choosing MP4 or WebM requests that container and falls back safely to a supported MediaRecorder MIME type when needed.",
    fixture: "short timeline video export fixture",
    id: "export.video.format",
    kind: "control",
    optionCoverage: ["mp4", "webm"],
    target: "export.video.format",
    userAction:
      "Choose MP4, export video, verify unsupported MP4 falls back safely if needed, then choose WebM and export again.",
  },
  {
    automated: true,
    automatedTestName: "video resolution changes encoder dimensions",
    browser: true,
    browserTestName: "browser: video export produces timeline-duration metadata",
    componentType: "select",
    evidence: "exported-bytes",
    expectedObservable:
      "Choosing Current uses the current even canvas dimensions, while 4K fits inside 3840x2160 with even dimensions.",
    fixture: "short timeline video export fixture",
    ...
    userAction:
      "Choose Current and 4K video resolution, export, load metadata, and verify video dimensions.",
  },
  {
    actionCoverage: ["export.svg", "export.png", "export.video"],
    automated: true,
    automatedTestName: "exports svg image and animated video output",
    browser: true,
    browserTestName: "browser: footer exports create svg image and video bytes",
    componentType: "panelActions",
    evidence: "exported-bytes",
    expectedObservable:
      "Export SVG creates SVG text/vector bytes, Export PNG creates PNG/JPG image bytes using image settings, and Export Video creates MP4/WebM-compatible video bytes using video settings.",
    fixture: "default ASCII output delivery fixture",
    id: "actions.output",
    kind: "control",
    target: "actions.output",
    userAction:
      "Click Export SVG, Export PNG, and Export Video; verify each returned Promise shows footer progress and creates downloadable bytes.",
  },
  {
    automated: true,
    automatedTestName: "timeline playback controls deterministic ASCII loop",
    browser: true,
    browserTestName: "browser: motion speed and timeline change rendered frames",
    componentType: "timeline",
    evidence: "timeline-output",
    expectedObservable:
      "The runtime timeline controls play/pause, scrub position, duration, looping, and rendered ASCII frames at the selected time.",
    fixture: "timeline playback ASCII pattern fixture",
    ...
    userAction:
      "Edit timeline duration through the UI, scrub to start, midpoint, and end, then prove the seamless forward-only loop stitches first and last frames without a visible jump after changing duration; motion advances in one direction and has no mirror, no yoyo, no ping-pong, and no reverse fallback before pausing and resuming playback.",
  },
  {
    automated: true,
    automatedTestName: "resolution scale changes preview backing pixels",
    browser: true,
    browserTestName: "browser: native preview dimensions match canvas output size",
    componentType: "slider",
    evidence: "rendered-pixels",
    expectedObservable:
      "Dragging Resolution scale changes the canvas backing pixels while the visible preview and exported output size stay stable.",
    fixture: "default ASCII preview with render scale set to 2",
    id: "canvas.renderScale",
    kind: "control",
    target: "canvas.renderScale",
    userAction:
      "Verify the Resolution scale control renders as the Toolcraft discrete slider variant with markers, drag it smoothly, and observe the backing pixels change without resizing the visible output.",
  },
  {
    automated: true,
    automatedTestName: "persistence reload restores edited ASCII settings",
    browser: true,
    browserTestName: "browser: persistence reload restores edited pattern settings",
    componentType: "persistence",
    evidence: "persistence-state",
    expectedObservable:
      "After changing a user-facing Pattern setting, page.reload restores the persisted control value and product output.",
    fixture: "localStorage persisted ASCII pattern fixture",
    id: "persistence.reload",
    kind: "runtime",
    persistenceCoverage: "reload",
    target: "persistence.localStorage",
    userAction:
      "Change Density, wait for persistence, reload the browser page, and observe the restored Density value and ASCII output.",
  },
  {
    automated: true,
    automatedTestName: "video reference motif maps to generated ASCII renderer",
    browser: true,
    browserTestName: "browser: reference video motif is reproduced in product output",
    componentType: "custom-renderer",
    evidence: "product-output",
    expectedObservable:
      "The generated renderer shows black-backed ASCII particles, organic void islands, and diagonal/wave dither bands corresponding to the storyboard frames and latest visual direction.",
    fixture: "reference video motif storyboard fixture",
    id: "reference.video.motif",
    kind: "runtime",
    target: "reference.video.motif",
    userAction:
      "Compare the product output against the extracted frame storyboard and verify the motif structure is present.",
  },
  {
    automated: true,
    automatedTestName: "video reference motion maps to timeline loop",
    browser: true,
    browserTestName: "browser: reference video motion breathes across timeline frames",
    componentType: "custom-renderer",
    evidence: "timeline-output",
    expectedObservable:
      "Timeline frames progress from sparse/high-contrast particles to denser gray fields and back toward sparse output like the reference transition analysis.",
    fixture: "reference video motion storyboard fixture",
    id: "reference.video.motion",
    kind: "runtime",
    target: "reference.video.motion",
    userAction:
      "Scrub the timeline across the loop and verify output changes through sparse, dense, and returning sparse states.",
  },
];
...
export const starterControlSectionInventory: readonly ToolcraftControlSectionInventoryEntry[] = [
  ...
  {
    entity: "Timeline-driven field motion",
    groupingReason:
      "Speed tunes how far the procedural field travels during the runtime timeline loop.",
  ...
  },
  {
    ...
    groupingReason:
      "The Include switch and background color jointly control preview and PNG background behavior.",
    targets: ["export.includeBackground", "appearance.background"],
    title: "Background",
  },
  {
    entity: "Still image export",
    groupingReason:
      "Format and resolution are the compact workflow pair for PNG/JPG image output.",
  ...
  },
  {
    entity: "Video export",
    groupingReason:
      "Format and resolution are the compact workflow pair for MP4/WebM animation output.",
...
export function validateToolcraftAcceptanceCoverage(
  ...
  const usesAppContract = schema === appSchema && acceptance === appAcceptance;
  const neutralTransferMode: ToolcraftTransferMode = { mode: "new-toolcraft-app" };
  const effectiveTransferMode: ToolcraftTransferMode =
    transferMode ??
    (usesAppContract ? appTransferMode : neutralTransferMode);
  const effectiveSectionInventory =
    sectionInventory ?? (usesAppContract ? starterControlSectionInventory : []);
  const errors: string[] = [];
  ...
  const animationIntent = effectiveTransferMode.animationIntent;
  ...
  const transferModeEvidenceText = getToolcraftTransferModeEvidenceText(effectiveTransferMode);

  if (
    videoReferenceEvidencePattern.test(transferModeEvidenceText) &&
    !effectiveTransferMode.videoReferenceStudy
  ) {
    errors.push(
  ...
  if (effectiveTransferMode.videoReferenceStudy) {
    errors.push(
  ...
  if (
    effectiveTransferMode.mode === "new-toolcraft-app" &&
  ...
  if (effectiveTransferMode.mode === "reference-runtime-clone") {
    const declaredReferenceCoverage = new Set(effectiveTransferMode.behaviorCoverage);
    const referenceTimeline = effectiveTransferMode.referenceTimeline;
    const referenceStudy = effectiveTransferMode.referenceStudy;
    const referenceFeatureInventory = effectiveTransferMode.referenceFeatureInventory ?? [];
    const acceptanceById = new Map(acceptance.map((entry) => [entry.id, entry]));
    ...
    if (!effectiveTransferMode.referenceName.trim()) {
      errors.push(
        "reference-runtime-clone transferMode must name the reference app or artifact.",
      );
    }

    if (effectiveTransferMode.sourceOfTruth !== "reference-runtime") {
      errors.push(
